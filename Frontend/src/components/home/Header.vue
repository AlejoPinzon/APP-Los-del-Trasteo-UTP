        ...
        <section class="menu-section-area">
            ...
            <b-navbar v-b-scrollspy:list-of-sections v-b-scrollspy="20" class="navbar navbar-expand-lg fixed-top d-none d-sm-none d-md-block d-lg-block d-xl-block" id="mainNav">
                <div class="container">
                    ...
                    <b-img :src="require('../../assets/img/logo.png')" img-alt="Los del trasteo" class="img-fluid"></b-img>
                    </router-link>
                    ...
                    <div class="collapse navbar-collapse" id="navbarResponsive">
                        <ul class="navbar-nav text-capitalize ml-auto">
                            <li class="nav-item">
                                <a class="nav-link js-scroll-trigger" href="#home" target="_self">Home</a>
                            </li>
                            <li class="nav-item dropdown"><a href="#" class="nav-link js-scroll-trigger dropdown-toggle" data-toggle="dropdown">Conocenos<i class="fas fa-angle-down"></i></a>
                                <ul class="dropdown-menu">
                                    <li><a class="nav-link js-scroll-trigger" href="#team" target="_self">Nuestro Equipo</a></li>
                                    <li><a class="nav-link js-scroll-trigger" href="#news" target="_self">Noticias</a></li>
                                    <li><a class="nav-link js-scroll-trigger" href="#news" target="_self">Blog</a></li>
                                </ul>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link js-scroll-trigger" href="#about" target="_self">Servicios</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link js-scroll-trigger" href="#contact" target="_self">Contactanos</a>
                            </li>
                            <li class="nav-item">
                                <router-link to="/login" class="nav-link js-scroll-trigger theme-button" >Vinculate</router-link>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <b-container fluid>
                    ...
                    <b-collapse id="nav-collapse" is-nav>
                        ...
                        <b-navbar-nav class="ml-auto">
                            ...
                            <b-nav-item-dropdown to="/" text="Conocenos" no-caret class="fas fa-angle-down">
                                <b-dropdown-item to="/">Nuestro Equipo</b-dropdown-item>
                                <b-dropdown-item to="/home2">Noticias</b-dropdown-item>
                                <b-dropdown-item to="/home3">Blog</b-dropdown-item>
                            </b-nav-item-dropdown>
                            <b-nav-item href="#about">Servicios</b-nav-item>
                            <b-nav-item href="#contact">Contactanos</b-nav-item>
                            <b-nav-item href="#download"><span class="theme-button">Vinculate</span></b-nav-item>
                        </b-navbar-nav>
                    </b-collapse>
