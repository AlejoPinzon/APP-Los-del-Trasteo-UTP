<template>
    <div>
        ...
        <section class="menu-section-area3">
            <!-- Navigation -->
            <b-navbar v-b-scrollspy:list-of-sections v-b-scrollspy="20" class="navbar navbar-expand-lg fixed-top d-none d-sm-none d-md-block d-lg-block d-xl-block" id="mainNav3">
                <div class="container">
